...
const AboutUs = () => {
    return (
        <div className="container-about">
            <div className="We-about">
                <img className="w-85" src={teamWork} alt="t_work"/>
                <h2>درباره ما</h2>
                <h4>
            ...
            <div className="We-about">
                <img className="w-h-53" src={illustration} alt="ill_ion"/>
                <h2>هویت ما</h2>
                <h4>
            ...
            <div className="We-about">
                <img className="w-h-79" src={group} alt="history"/>
                <h2 className="font-smart">تاریخچه اسمارت شاپ</h2>
            ...
            <div className="We-about">
                <img className="w-h-50" src={groupF} alt="g_f"/>
